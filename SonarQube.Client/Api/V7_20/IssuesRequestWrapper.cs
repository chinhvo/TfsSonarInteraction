...
namespace SonarQube.Client.Api.V7_20
{
    ...
    /// </summary>
    public class IssuesRequestWrapper : IGetIssuesRequest
    {
        ...
        public async Task<SonarQubeIssue[]> InvokeAsync(HttpClient httpClient, CancellationToken token, object body = null)
        {
            ...
            innerRequest.AdditionalFields = "_all";
