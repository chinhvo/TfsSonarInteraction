...
namespace SonarQube.Client.Requests
{
    ...
    public abstract class RequestBase<TResponse> : IRequest<TResponse>
    {
        ...
        public virtual async Task<TResponse> InvokeAsync(HttpClient httpClient, CancellationToken token, object body = null)
        {
        ...
        protected async Task<Result<TResponse>> InvokeUncheckedAsync(HttpClient httpClient, CancellationToken token, object body = null)
        {
            ...
            var json = JsonConvert.SerializeObject(body, Formatting.Indented, new JsonSerializerSettings() { ContractResolver = new CamelCasePropertyNamesContractResolver() });
