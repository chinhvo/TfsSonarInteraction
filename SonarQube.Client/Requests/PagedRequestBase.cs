...
namespace SonarQube.Client.Requests
{
    ...
    public abstract class PagedRequestBase<TResponseItem> : RequestBase<TResponseItem[]>, IPagedRequest<TResponseItem>
    {
        ...
        public override async Task<TResponseItem[]> InvokeAsync(HttpClient httpClient, CancellationToken token, object body = null)
        {
            ...
            do
            {
                pageResult = await InvokeUncheckedAsync(httpClient, token, body);
